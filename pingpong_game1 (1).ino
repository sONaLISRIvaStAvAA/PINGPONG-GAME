/*
  ...
  - Buzzer: Pin 9 (with new RPG and Click sounds)
  - Speed Knob: Pin A0
*/
...
void setup() {
  ...
  // --- NEW: RPG Start-up Sound ---
  // (Plays a C-Major arpeggio: C-E-G-C)
  ...
  // --- NEW: "Click" sound for serve ---
  tone(buzzerPin, 800, 20); // Short, sharp "click"
...
void endGame() {
  ...
  // --- NEW: Game Over / Victory Jingle ---
  // (Plays a G-C-E "level up" sound)
  tone(buzzerPin, 784, 100); // G5
  delay(110);
  tone(buzzerPin, 1047, 100); // C6
  delay(110);
